...
# Header
### Set Title
st.title("Dow Jones Trend Predictor")
st.write("""From the input news, predict upward or downward trend.""")

# Text input
text = st.text_area("Input news", 'Input text here.')
...
# Predicted rating
if prediction > 0:
    st.write(f'Predicted Dow Jones Index trend is upwards.')
else:
    st.write(f'Predicted Dow Jones Index trend is downwards.')